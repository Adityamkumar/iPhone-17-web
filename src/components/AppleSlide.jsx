...
const AppleSlide = () => {
  return (
    <section className="xl:h-[86vh] lg:h-[46vh] md:h-[60vh] h-full max-w-full md:mt-12 mt-6">
          <h3 className="xl:ml-52 md:ml-10 ml-6 md:pt-12 md:text-[26px] text-xl tracking-tighter font-semibold">
          ...
          <div className="max-w-full md:min-h-[80vh] sm:min-h-[60vh] md:mt-7 mt-6 overflow-x-auto scroll-smooth">
            <div className="flex md:gap-8 gap-6  xl:ml-48 md:ml-8 ml-6">
