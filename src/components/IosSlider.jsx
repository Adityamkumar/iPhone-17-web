...
const IosSlider = () => {
  return (
    <section className="md:min-h-[70vh] h-full max-w-full md:mt-16 mt-6">
          <h3 className="md:ml-52 ml-6 md:pt-32 md:text-[26px] text-xl tracking-tighter font-semibold">
