...
const Accessories = () => {
  return (
    <section className='md:min-h-[52vh] h-full md:mt-10 mt-8'>
        <h3 className='access tracking-tighter md:pt-14 xl:ml-56 md:ml-10 ml-5 md:text-6xl text-2xl font-semibold md:font-bold'>Snap it on. Show it off.</h3>
        <div className='xl:ml-56 md:ml-6 overflow-x-scroll scroll-smooth  md:mt-6 mt-5 md:flex md:flex-row md:gap-1 gap-4  flex flex-col'>
            <div>
