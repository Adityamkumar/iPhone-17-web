...
const Accessories = () => {
  return (
    <section className='md:min-h-[90vh] md:mt-10'>
        <h3 className='access tracking-tighter md:pt-14 md:ml-56 ml-5 md:text-6xl text-2xl font-semibold md:font-bold'>Snap it on. Show it off.</h3>
        <div className='md:ml-56  md:mt-6 mt-5 md:flex md:flex-row md:gap-1 gap-4  flex flex-col'>
            <div>
