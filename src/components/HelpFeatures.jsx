...
const HelpFeatures = () => {
  return (
    <section className='md:min-h-[65vh] h-full  mt-8 md:mt-10'>
        <div>
            <h2  className='lg:ml-52 md:ml-10 ml-6 md:pt-32 md:text-[26px] text-xl tracking-tighter leading-8 font-semibold'>Helpful features.<br/> Just in case.</h2>
        </div>
        <div className='lg:ml-52 md:ml-6 overflow-x-scroll scroll-smooth md:mt-6 mt-4 md:flex md:flex-row lg:gap-16 flex flex-col'>
            <div className='px-4'>
